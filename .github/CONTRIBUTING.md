...
**Do not edit `neoblaze.css`, and do not commit any dist files (`dist/`).** Those files are automatically generated by our build tools. You should edit the source files in /`neoblaze/src/scss/`
...
Neoblaze uses npm scripts to compile source files and docs.
To run the project locally follow these steps:

1. Clone the repo. 
2. Navigate to `/neoblaze` directory.
3. Run `npm install` to install all the local dependencies.
4. Run `npm start` to locally run the project.

### Documentation

1. Navigate to `/neoblaze/site/content/docs/` directory.
2. Run `npm install` to install all the local dependencies.
3. Run `npm start` to locally run the documentation and site.
